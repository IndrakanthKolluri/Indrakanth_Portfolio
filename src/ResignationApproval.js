          ...
          <table className="w-full">
            <thead>
              <tr>
                ...
                <th className="border border-solid border-black p-4 bg-gray-300">
                  <select onChange={(e) => setPendingFilters({ ...pendingFilters, role: e.target.value })} className="bg-gray-300">
                ...
                <th className="border border-solid border-black p-4 bg-gray-300">Notice Period Days</th>
            ...
            <tbody>
              {pendingRequestsToShow.map(req => (
                <tr key={req.id}>
                  ...
                  <td className="border border-solid border-black p-4">{req.role}</td>
                  <td className="border border-solid border-black p-4">{req.noticePeriodDays}</td>
          ...
          <table className="w-full">
            <thead>
              <tr>
                ...
                <th className="border border-solid border-black p-4 bg-gray-300">
                  <select onChange={(e) => setAllFilters({ ...allFilters, role: e.target.value })} className="bg-gray-300">
                    <option value="">Role</option>
