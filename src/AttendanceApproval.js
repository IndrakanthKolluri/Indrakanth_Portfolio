...
function AttendanceApproval() {
  const [pendingRequests, setPendingRequests] = useState([
    { id: 1, name: 'John Doe', type: 'Work From Home', from: '2023-10-01', to: '2023-10-03', duration: '3 days', comments: 'Feeling unwell' },
    { id: 2, name: 'Jane Smith', type: 'Work From Office', from: '2023-10-10', to: '2023-10-15', duration: '5 days', comments: 'Family trip' },
    { id: 3, name: 'Alice Johnson', type: 'Work From Home', from: '2023-10-12', to: '2023-10-20', duration: '8 days', comments: 'Going to the beach' },
    { id: 4, name: 'Bob Brown', type: 'Work From Home', from: '2023-10-15', to: '2023-10-18', duration: '3 days', comments: 'Personal matters' },
    { id: 5, name: 'Charlie Green', type: 'Work From Office', from: '2023-10-20', to: '2023-10-25', duration: '5 days', comments: 'Visit relatives' },
  ]);
      ...
      <div className='flex flex-col items-center'>
        ...
        <div className='border border-black rounded p-4 '>
          <div className='flex flex-row justify-between items-center'>
            <h1 className="font-bold pb-3">Attendance Approvals/Pending</h1>
